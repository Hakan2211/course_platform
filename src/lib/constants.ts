export const COURSE_TITLE = 'Course_Platform_Title';
...
export const LIGHT_COLOR = {
  ...
  '--alert-danger': '#F1A7A7',
  '--alert-danger-border': '#EE9595',
  '--alert-danger-icon': '#f09494',
  '--alert-bg-info': '#04264E',
  '--alert-bg-warning': '#F9B310',
  '--alert-bg-success': '#053817',
  '--alert-bg-danger': '#8f1414',
